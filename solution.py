...
class SOLUTION:
    ...
    def Generate_Body(self):
        ...
        pyrosim.Send_Cube(name="BackLeg1", pos=[0.25,-0.5,0], size=[0.1,1,0.1])
        pyrosim.Send_Joint(name="Torso_BackLeg2", parent="Torso", child="BackLeg2", type="revolute", position=[0,-0.5,1], jointAxis = "1 0 0")
        pyrosim.Send_Cube(name="BackLeg2", pos=[-0.25,-0.5,0], size=[0.1,1,0.1])
        pyrosim.Send_Joint(name="Torso_FrontLeg1", parent="Torso", child="FrontLeg1", type="revolute", position=[0,0.5,1], jointAxis = "1 0 0")
        pyrosim.Send_Cube(name="FrontLeg1", pos=[0.25,0.5,0], size=[0.1,1,0.1])
        pyrosim.Send_Joint(name="Torso_FrontLeg2", parent="Torso", child="FrontLeg2", type="revolute", position=[0,0.5,1], jointAxis = "1 0 0")
        pyrosim.Send_Cube(name="FrontLeg2", pos=[-0.25,0.5,0], size=[0.1,1,0.1])
        pyrosim.Send_Joint(name="Torso_LeftLeg1", parent="Torso", child="LeftLeg1", type="revolute", position=[-0.5, 0, 1], jointAxis="0 1 0")
        pyrosim.Send_Cube(name="LeftLeg1", pos=[-0.5, 0.4, 0], size=[1, 0.1, 0.1])
        pyrosim.Send_Joint(name="Torso_LeftLeg2", parent="Torso", child="LeftLeg2", type="revolute", position=[-0.5, 0, 1], jointAxis="0 1 0")
        pyrosim.Send_Cube(name="LeftLeg2", pos=[-0.5, 0, 0], size=[1, 0.1, 0.1])
        pyrosim.Send_Joint(name="Torso_LeftLeg3", parent="Torso", child="LeftLeg3", type="revolute", position=[-0.5, 0, 1], jointAxis="0 1 0")
        pyrosim.Send_Cube(name="LeftLeg3", pos=[-0.5, -0.4, 0], size=[1, 0.1, 0.1])
        pyrosim.Send_Joint(name="Torso_RightLeg1", parent="Torso", child="RightLeg1", type="revolute", position=[0.5, 0, 1], jointAxis="0 1 0")
        pyrosim.Send_Cube(name="RightLeg1", pos=[0.5, 0.4, 0], size=[1, 0.1, 0.1])
        pyrosim.Send_Joint(name="Torso_RightLeg2", parent="Torso", child="RightLeg2", type="revolute", position=[0.5, 0, 1], jointAxis="0 1 0")
        pyrosim.Send_Cube(name="RightLeg2", pos=[0.5, 0, 0], size=[1, 0.1, 0.1])
        pyrosim.Send_Joint(name="Torso_RightLeg3", parent="Torso", child="RightLeg3", type="revolute", position=[0.5, 0, 1], jointAxis="0 1 0")
        pyrosim.Send_Cube(name="RightLeg3", pos=[0.5, -0.4, 0], size=[1, 0.1, 0.1])
        ...
        pyrosim.Send_Cube(name="FrontLowerLeg1", pos=[0.25,0,-0.5], size=[0.1,0.1,1])
        ...
        pyrosim.Send_Cube(name="FrontLowerLeg2", pos=[-0.25,0,-0.5], size=[0.1,0.1,1])
        ...
        pyrosim.Send_Cube(name="BackLowerLeg1", pos=[0.25,0,-0.5], size=[0.1,0.1,1])
        ...
        pyrosim.Send_Cube(name="BackLowerLeg2", pos=[-0.25,0,-0.5], size=[0.1,0.1,1])
        ...
        pyrosim.Send_Cube(name="LeftLowerLeg1", pos=[0,0.4,-0.5], size=[0.1,0.1,1])
        ...
        pyrosim.Send_Cube(name="LeftLowerLeg2", pos=[0,0,-0.5], size=[0.1,0.1,1])
        pyrosim.Send_Joint(name="LeftLeg3_LeftLowerLeg3", parent="LeftLeg3", child="LeftLowerLeg3", type="revolute", position=[-1,0,0], jointAxis = "0 1 0")
        pyrosim.Send_Cube(name="LeftLowerLeg3", pos=[0,-0.4,-0.5], size=[0.1,0.1,1])
        ...
        pyrosim.Send_Cube(name="RightLowerLeg1", pos=[0,0.4,-0.5], size=[0.1,0.1,1])
        ...
        pyrosim.Send_Cube(name="RightLowerLeg2", pos=[0,0,-0.5], size=[0.1,0.1,1])
        pyrosim.Send_Joint(name="RightLeg3_RightLowerLeg3", parent="RightLeg3", child="RightLowerLeg3", type="revolute", position=[1,0,0], jointAxis = "0 1 0")
        pyrosim.Send_Cube(name="RightLowerLeg3", pos=[0,-0.4,-0.5], size=[0.1,0.1,1])
        pyrosim.End()
    ...
    def Generate_Brain(self):
        ...
        pyrosim.Send_Sensor_Neuron(name = 6, linkName = "LeftLowerLeg3")
        pyrosim.Send_Sensor_Neuron(name = 7, linkName = "RightLowerLeg1")
        pyrosim.Send_Sensor_Neuron(name = 8, linkName = "RightLowerLeg2")
        pyrosim.Send_Sensor_Neuron(name = 9, linkName = "RightLowerLeg3")
        pyrosim.Send_Motor_Neuron(name = 10, jointName = "Torso_BackLeg1")
        ...
        pyrosim.Send_Motor_Neuron(name = 16, jointName = "Torso_LeftLeg3")
        ...
        pyrosim.Send_Motor_Neuron(name = 20, jointName = "BackLeg1_BackLowerLeg1")
        pyrosim.Send_Motor_Neuron(name = 21, jointName = "BackLeg2_BackLowerLeg2")
        pyrosim.Send_Motor_Neuron(name = 22, jointName = "FrontLeg1_FrontLowerLeg1")
        pyrosim.Send_Motor_Neuron(name = 23, jointName = "FrontLeg2_FrontLowerLeg2")
        pyrosim.Send_Motor_Neuron(name = 24, jointName = "LeftLeg1_LeftLowerLeg1")
        pyrosim.Send_Motor_Neuron(name = 25, jointName = "LeftLeg2_LeftLowerLeg2")
        pyrosim.Send_Motor_Neuron(name = 26, jointName = "LeftLeg3_LeftLowerLeg3")
        pyrosim.Send_Motor_Neuron(name = 27, jointName = "RightLeg1_RightLowerLeg1")
        pyrosim.Send_Motor_Neuron(name = 28, jointName = "RightLeg2_RightLowerLeg2")
        pyrosim.Send_Motor_Neuron(name = 29, jointName = "RightLeg3_RightLowerLeg3")
